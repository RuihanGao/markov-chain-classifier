...
if __name__ == '__main__':
    ...
    # subprocess.check_output: run the command and return the output as byte string
    ...
    if 'gpuhost' in hostname:
        ...
        log.debug(nvidiasmi)
    tf.app.run() # Runs the program with an optional 'main' function and 'argv' list, nothing to do with NN
